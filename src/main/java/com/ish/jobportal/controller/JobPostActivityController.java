...
import com.ish.jobportal.entity.RecruiterProfile;
import com.ish.jobportal.entity.Users;
import com.ish.jobportal.services.JobPostActivityService;
import com.ish.jobportal.services.JobSeekerApplyService;
import com.ish.jobportal.services.JobSeekerSaveService;
import com.ish.jobportal.services.UsersService;
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                if (currentUserProfile instanceof JobSeekerProfile seekerProfile) {
                    jobSeekerApplyList = jobSeekerApplyService.getCandidatesJobs(seekerProfile);
                    jobSeekerSaveList = jobSeekerSaveService.getCandidatesJob(seekerProfile);
    }
                boolean exist;
                boolean saved;
